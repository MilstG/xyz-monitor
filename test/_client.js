...
const CLIENT_MODULES = ["core", "base", "data", "markets", "corr", "drawer", "prefs", "alerts", "admin", "positioning", "backtest", "charts",
  "triggers", "actionable", "calendar", "notes", "trend", "sectors", "drawdown", "ematouch", "retest", "share", "nav", "terminal", "report", "focus", "funds", "insiders", "messages", "access", "usage", "usageadm"];
