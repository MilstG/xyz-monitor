...
// Weak ETag from the payload's data version so unchanged snapshots revalidate to 304.
...
async function main() {
  ...
  // The healthcheck must stay open or Railway will mark the deploy unhealthy.
  if (SITE_PASSWORD) {
