...
// Tab-only modules (charts, drawdown, funds, insiders, positioning) are NOT imported here since
// build 2026.09.24-103: core.js lazyCall() imports each on first use and runs its __boot_* then —
// see LAZY_IMPORTERS there.
